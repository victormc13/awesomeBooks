...
**[awesomeBooks]** is a project that makes a list of your favorite books.
...
```sh
  cd my-folder
  git clone https://github.com/victormc13/awesomeBooks.git
```
...
Feel free to check the [issues page](https://github.com/victormc13/awesomeBooks/issues).
